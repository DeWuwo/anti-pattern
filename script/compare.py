...
if __name__ == '__main__':
    cp = Compare('D:\\Honor\\match_res\\LineageOS\\base\\lineage-18.1\\coupling-patterns\\res.json',
                 'D:\\Honor\\match_res\\LineageOS\\base\\lineage-19.1\\coupling-patterns\\res.json')
